...
"""This are movie instances defined using class movie """
zootopia = media.Movie("Zootopia",
                       "Welcome to the urban jungle. ",
                       "http://vignette4.wikia.nocookie.net/"
                       "disney/images/2/2f/"
                       "Zootopia_Poster.jpg/revision/latest?cb=20160615162624",
                       "https://www.youtube.com/watch?v=5nP9hU8eUfE")

tangled = media.Movie("Tangled",
                      "Get tangled up.",
                      "http://www.filmofilia.com/wp-content/uploads/2010/11/"
                      "tangled_poster_nov.jpg",
...
finding_nemo = media.Movie("Finding Nemo",
                           ...
                           "https://d35fkdjhhgt99.cloudfront.net/static/"
                           "use-media-items/17/16316/full-900x1300/56702cc2/"
                           "pva6ds.jpeg?resolution=0",
...
"""array of movie instances is sent to module fresh tomatoes """
